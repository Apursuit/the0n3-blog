...
description: >-
  ciscn2023 web 部分 wp：收录 Unzip（zip 软链接 + unzip -o 覆盖机制把木马解压到网站根目录 Getshell）与 go_session（Go 应用 session 相关漏洞）两道题。
---
学习下ciscn2023 web部分
...
![11](/images/ciscn2023/11.png)

访问flask路由执行命令

![12](/images/ciscn2023/12.png)
