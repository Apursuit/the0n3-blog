...
description: >-
  玄机应急响应第一章 webshell 查杀：通过打包源码 + D盾扫描定位 WebShell，识别哥斯拉特征（getBasicsInfo、隐藏代码），计算工具地址与隐藏路径的 md5，并分析免杀马原理。
---
...
![1](/images/xj-webshell/1.png)

![2](/images/xj-webshell/2.png)
