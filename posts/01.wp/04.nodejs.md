...
description: >-
  CTFshow nodejs 334-338 wp：web334 源码审计（大小写绕过）、web335 / web336 child_process 命令执行（execSync / spawnSync）、web337、web338 原型链污染等 Node.js 安全考点。
---
...
![spawnSync](/images/show-nodejs/3.png)
...
![login](/images/show-nodejs/4.png)
