...
description: >-
  XYCTF 2024 web wp：收录 ezhttp（HTTP 头伪造）、warm up（extract 变量覆盖 + md5 绕过）、ezmake / ez?make（命令执行）、ezmd5、ezClass、ezPOP、ezRCE、ezSerialize（反序列化）以及「牢牢记住，逝者为大」等 10 道题的解题过程。
---

# web

web题目对新手挺友好，比赛过程学到很多东西，做了7个web，404名哈哈，奇怪的数字 
![404](/images/xyctf-web/myXYCTF.png)
...
最后拿到flag  
![hackbar](/images/xyctf-web/hackbar.png)
...
![ez?make](/images/xyctf-web/test.png)
...
![图1](/images/xyctf-web/1.jpg)
 
![图2](/images/xyctf-web/2.jpg)
...
![ezclass](/images/xyctf-web/ezclass.png)
...
![ezpop](/images/xyctf-web/ezpop-f.png)
...
![ezRCE](/images/xyctf-web/ezrce-f.png)
...
![ctfer](/images/xyctf-web/ctfer.png)
