...
description: >-
  CTFshow 单身杯 web wp：收录「签到·好玩的 PHP」（md5 绕过）、「ezzz_ssti」（SSTI 长度限制绕过）、「ez_inject」、「迷雾重重」等题的解思路。
---
...
![1](/images/show-DSB/1.png)

![2](/images/show-DSB/2.png)

![3](/images/show-DSB/3.png)
...
![11](/images/show-DSB/11.png)

这里预期希望达到一个像sql盲注的效果，通过提示判断flag每一位的值

![12](/images/show-DSB/12.png)
