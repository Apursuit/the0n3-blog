...
description: >-
  BUU 平台 Flask wp：收录 [pasecactf_2019]flask_ssti（过滤绕过 + __subclasses__ 链）、[HFCTF 2021 Final]easyflask、[GYCTF2020]FlaskApp，以及通过 Flask debug shell 读取源码等利用思路。
---
...
![8](/images/buuflask/8.png)


太有意思啦！！

![7](/images/buuflask/7.png)
...
![16](/images/buuflask/16.png)

![17](/images/buuflask/17.png)
