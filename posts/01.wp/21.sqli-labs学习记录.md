...
description: >-
  sqli-labs 全关卡（Less-1 至 Less-66）学习记录：从 Docker 搭建环境开始，结合源码讲解字符型与数字型注入、报错注入、联合查询、布尔与时间盲注、宽字节、堆叠、order by 注入等原理与 payload。
---


有时间就要学习

![1](/images/sqli-labs/1.png)
...
![2](/images/sqli-labs/2.png)

## Less-1

get传参 `?id=1'`时页面报错，可以猜测后台sql语句类似

![3](/images/sqli-labs/3.png)
...
![21](/images/sqli-labs/21.png)

![20](/images/sqli-labs/20.png)
...
![26](/images/sqli-labs/26.png)

`mysql_error()`放出来了？那上面几题是不是也能报错注入？我去试试☝🤓

![27](/images/sqli-labs/27.png)
...
![29](/images/sqli-labs/29.png)

这里为什么用户名不能注入？翻看源码

![30](/images/sqli-labs/30.png)
...
![35](/images/sqli-labs/35.png)

```sql
a',1,updatexml(1,concat(0x7e,user(),0x7e),1))#
```

![36](/images/sqli-labs/36.png)
...
![46](/images/sqli-labs/46.png)

![47](/images/sqli-labs/47.png)
...
![76](/images/sqli-labs/76.png)

这又是什么奇怪的报错 🤯

![77](/images/sqli-labs/77.png)
...
![80](/images/sqli-labs/80.png)

## Less-42

查看源码，题目在登录的处理方面，对`username`做了过滤，`password`没有过滤

![81](/images/sqli-labs/81.png)
...
![87](/images/sqli-labs/87.png)

![88](/images/sqli-labs/88.png)
...
![101](/images/sqli-labs/101.png)

怎么跟`Less-48`一样？翻看源码，发现这道题可以堆叠注入了

![102](/images/sqli-labs/102.png)
...
![104](/images/sqli-labs/104.png)

2，3为回显位

![105](/images/sqli-labs/105.png)
