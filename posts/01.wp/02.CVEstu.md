...
description: >-
  CTFshow web311-314 CVE 复现 wp：web311 CVE-2019-11043（Nginx + php-fpm RCE）、web312 CVE-2018-19158（PHP imap_open 命令注入）、web313 CVE-2012-1823（PHP-CGI 远程代码执行）、web314（PHP 包含 POST 临时文件）四道 CVE 题。
---
