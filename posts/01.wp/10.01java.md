...
description: >-
  BUU 简单 Java Web wp：收录 [RoarCTF 2019]Easy Java（任意文件下载读取 /WEB-INF/web.xml 与 class 文件、jd-gui 反编译）和 [网鼎杯 2020 青龙组]filejava（下载目录穿越）两道题。
---
## [RoarCTF 2019]Easy Java

buu平台一道简单java web[[RoarCTF 2019]Easy Java](https://buuoj.cn/challenges#[RoarCTF%202019]Easy%20Java)

![1](/images/buujava/1.png)

打开题目，一个登录页面，可以bp爆破出弱密码`admin/admin888`

![2](/images/buujava/2.png)

登录页没什么内容

![3](/images/buujava/3.png)
...
![7](/images/buujava/7.png)

![8](/images/buujava/8.png)

穿越下载java web的配置文件web.xml

![9](/images/buujava/9.png)
...
![10](/images/buujava/10.png)

审计`ListFileServlet.class`，没有什么可以利用的

![11](/images/buujava/11.png)
...
![14](/images/buujava/14.png)

![13](/images/buujava/13.png)
