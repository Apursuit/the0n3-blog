...
description: >-
  玄机应急响应 Linux 入侵排查：通过 D盾定位一句话木马与不死马、分析 index.php 生成隐藏后门的机制，并用微步云沙箱分析恶意 ELF 得到 C2 的 IP 与端口。
---
