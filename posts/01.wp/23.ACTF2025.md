...
description: >-
  ACTF2025 web 部分 wp：收录 upload（路径穿越读取 /proc/self/cmdline 与源码、Flask session 伪造）与 not so web 1 两道题的解题过程。
---


![0](/images/actf2025/0.png)
