...
description: >-
  CTFshow 常见姿势 wp（web801-812）：收录 Flask PIN 计算、Phar 反序列化、open_basedir 绕过（glob:// 协议、DirectoryIterator / SplFileObject 原生类）等多道题的 trick。
---
...
![10](/images/show800/10.png)

![11](/images/show800/11.png)
...
![15](/images/show800/15.png)

尝试使用这些文件进行包含，发现`**cmd.php`文件不能直接用来包含，需要更改配置文件，`System.php`、`PEAR.php`可以

![16](/images/show800/16.png)

![17](/images/show800/17.png)
