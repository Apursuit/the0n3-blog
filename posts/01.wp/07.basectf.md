...
description: >-
  BaseCTF 2024 web 部分 wp：按周收录多道题，涵盖信息收集、HTTP 头、md5 绕过、文件上传、PHP 伪协议、POP 链反序列化、MD5 长度扩展、RCE、SQL 注入等，含 [Week1] A Dark Room、Aura 酱的礼物、[Week2] Really EZ POP、所以你说你懂 MD5?、[Fin] 1z_php 等。
---

![empty](/images/basectf/empty.jpg)
