...
description: >-
  buildCTF web wp：收录 ez!http（HTTP 头伪造）、find-the-id、我写的网站被 rce 了？、babyupload、LovePopChain、RedFlag、ez_md5、Cookie_Factory、快来破解漂亮国蓝宫的 WAF 等十余道题。
---
...
![2](/images/buildCTF/2.png)

![3](/images/buildCTF/3.png)

## find-the-id

bp直接爆破，id=207

![4](/images/buildCTF/4.png)
...
![10](/images/buildCTF/10.png)

![12](/images/buildCTF/12.png)

后来才想起来，原来有简单的`cp`,`mv`等命令也可以实现命令结果写文件

![11](/images/buildCTF/11.png)
...
![14](/images/buildCTF/14.png)

发现这样还会检测，猜测是否是过滤了命令`env`，尝试使用`en''v`绕过，发现可以的

![15](/images/buildCTF/15.png)
...
![25](/images/buildCTF/25.png)

不过有点奇怪，没看懂为什么不管是`buıldctf`还是`BUıLDCTF`都可以登录成功

![26](/images/buildCTF/26.png)
...
![31](/images/buildCTF/31.png)

![30](/images/buildCTF/30.png)

点击下载，就会发起请求，下载sh文件，执行里面的内容

![32](/images/buildCTF/32.png)
...
![36](/images/buildCTF/36.png)

使用python打印10w个a填充垃圾数据，在末尾添加php代码

你过关！！

![34](/images/buildCTF/34.png)

![35](/images/buildCTF/35.png)
...
![38](/images/buildCTF/38.png)

并发30次，如果有漏签的，只能重开一个容器

![39](/images/buildCTF/39.png)

当时想到并发这种情况了，为什么没有去`just do it`呢(真心换绝情.jpg)

![40](/images/buildCTF/40.png)
