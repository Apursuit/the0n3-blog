...
description: >-
  CTFshow ThinkPHP 专题（web569-579、604-607）wp：从 pathinfo 与路由模式讲起，覆盖 ThinkPHP 3.2 / 5.x 等版本的路径利用、SQL 注入与远程代码执行漏洞。
---

学习一下框架(~~姿势~~)。在`ctfshow`靶场和tp官方文档的引导下，入门丝滑。


![tp](/images/show-think/tp.png)
...
![5](/images/show-think/5.png)

测试一下，`url/index.php/ctfshow/assert/phpinfo();`

完美

![6](/images/show-think/6.png)

对了。不要在参数里写`/`，这会和thinkphp这种把参数值写在url里的模式发生冲突

![7](/images/show-think/7.png)

可以传递参数，用个POST参数绕过一下

![8](/images/show-think/8.png)
...
![13](/images/show-think/13.png)

![14](/images/show-think/14.png)
...
![16](/images/show-think/16.png)


![17](/images/show-think/17.png)
...
![20](/images/show-think/20.png)

这里可以看到，条件只要合理，是完全可控的。通过测试，发现存在4个字段，第二个字段是会回显位

![21](/images/show-think/21.png)
...
![22](/images/show-think/22.png)


这里的括号可以闭合，下面操作就和上题一样了。狠狠的注入正能量！

![23](/images/show-think/23.png)
...
![26](/images/show-think/26.png)

![27](/images/show-think/27.png)
...
![29](/images/show-think/29.png)

尝试闭合前半部分，让sql报错

![30](/images/show-think/30.png)

闭合后半部分后，正常查询，当然，后半部分也可以直接通过`#`注释掉

![31](/images/show-think/31.png)
...
环境问题，我还一直以为我的是tp3.2.3，原来是tp3.2.5，天塌了
...
提一下，tp5 url模式不再区分大小写了，所以如果出现过滤关键词的情况，可以尝试大小写绕过
