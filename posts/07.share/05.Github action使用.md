...
description: >-
  GitHub Actions 入门教程：介绍官方虚拟机的定价与可用镜像（ubuntu / windows / macOS），手把手创建 .github/workflows 工作流，用 workflow_dispatch 手动触发打印 hello world，逐行讲解 name/on/jobs/runs-on/steps 等 YAML 字段，并说明用 actions/checkout 检出代码、用 artifact 工件保存和跨 job 共享文件。
---
...
![](/images/github-action/16.png)

![](/images/github-action/17.png)

python 报错，没有这个文件或文件夹

![](/images/github-action/18.png)
...
![](/images/github-action/20.png)

![](/images/github-action/21.png)
