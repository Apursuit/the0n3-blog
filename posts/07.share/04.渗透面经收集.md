...
description: >-
  渗透测试面试题（面经）收集：涵盖信息收集、whois、OWASP Top 10、常见端口、XXE、CDN 判断与真实 IP 绕过、正反向代理、Windows/Linux 提权、XSS/CSRF、nmap 参数、常见中间件解析漏洞，以及 Weblogic/ThinkPHP/Shiro/fastjson、OSS 云存储、webshell 写入、应急响应流程等高频面试题。
---
