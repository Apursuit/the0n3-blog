...
description: >-
  一台 Linux 提权靶机，通过 WordPress 插件漏洞获取容器权限，结合 Docker 环境分析、SUID 文件审计以及 Python __pycache__ 投毒实现权限提升。
---
...
**关键词**：__pycache__ 投毒、WordPress漏洞、文件上传RCE、Docker容器、sudo提权

**摘要**：一台 Linux 提权靶机，通过 WordPress 插件漏洞获取容器权限，结合 Docker 环境分析、SUID 文件审计以及 Python __pycache__ 投毒实现权限提升。
