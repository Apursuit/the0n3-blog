...
description: >-
  一台 Linux 提权靶机，通过 Git 历史泄露获取初始凭证，结合 SUID 程序代码审计，利用 PATH 劫持、SIGXFSZ 信号处理以及 inode 耗尽等机制完成权限提升。
---
...
**关键词**：Git泄露、PATH劫持、SUID提权、Linux提权、Inode耗尽

**摘要**：一台 Linux 提权靶机，通过 Git 历史泄露获取初始凭证，结合 SUID 程序代码审计，利用 PATH 劫持、SIGXFSZ 信号处理以及 inode 耗尽等机制完成权限提升。
...
![](/images/maze-worm/1.png)

尝试目录扫描发现 `.git`目录

![](/images/maze-worm/2.png)
