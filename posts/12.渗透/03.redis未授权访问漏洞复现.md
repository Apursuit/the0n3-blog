...
description: >-
  Redis 未授权访问漏洞复现：利用 Redis 默认绑定 0.0.0.0:6379 且无认证，通过 CONFIG SET dir/dbfilename + SET + SAVE 写入 webshell、SSH 公钥（免密登录 root）以及定时任务反弹 shell。含 Windows（phpstudy）与 Linux（自编译 Redis 3.0.0）两套环境，并深入分析 Ubuntu crontab 反弹 shell 失败的原因（dash、文件权限 600、RDB 乱码）。
---
...
![2](/images/redis未授权访问控制漏洞/2.png)

攻击机phpstudy安装redis，进入redis目录，存在redis-cli.exe

![3](/images/redis未授权访问控制漏洞/3.png)
...
![10](/images/redis未授权访问控制漏洞/10.png)
...
![14](/images/redis未授权访问控制漏洞/14.png)
...
![15](/images/redis未授权访问控制漏洞/15.png)
...
![16](/images/redis未授权访问控制漏洞/16.png)
...
![11](/images/redis未授权访问控制漏洞/11.png)
...
![12](/images/redis未授权访问控制漏洞/12.png)
...
![13](/images/redis未授权访问控制漏洞/13.png)
