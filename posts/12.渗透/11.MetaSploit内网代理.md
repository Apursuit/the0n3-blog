...
description: >-
  Metasploit 内网代理笔记：拿下入口机 Meterpreter 后，介绍三种访问内网的方式——autoroute 添加路由、portfwd 端口转发（含反向转发）、socks_proxy 启动 SOCKS5 代理，并演示用浏览器 SwitchyOmega / Proxifier 让工具流量走代理，附正向 shell 与反弹 shell 的选择建议。
---


在入口机上线Meterpreter后，把入口机作为跳板机，通过添加路由、端口转发、socks代理等多种方式访问内网

![](/images/msfproxy/1.png)
...
![](/images/msfproxy/2.png)

![](/images/msfproxy/3.png)

访问内网资源使用这个socks5代理

![](/images/msfproxy/4.png)
...
![](/images/msfproxy/5.png)

![](/images/msfproxy/6.png)
