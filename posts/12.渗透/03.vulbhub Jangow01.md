...
description: >-
  VulnHub Jangow01 靶机 Writeup：目录爆破发现 .backup 数据库配置泄露凭证，复用密码登录 FTP 读取后门 busque.php 获得 www-data 的 RCE；因靶机不出网无法反弹 shell，改用 Suo5 建立 HTTP 隧道并配合 proxychains 代理 SSH 拿到交互式 shell，最后用 DirtyCow / PwnKit 提权到 root。
---
...
![](/images/vulnhub-jangow01/10.png)

### 本地提权探测
使用中国蚁剑连接 Webshell，并上传 `linpeas.sh` 进行提权辅助扫描。

![](/images/vulnhub-jangow01/11.png)

执行扫描并查看结果：

![](/images/vulnhub-jangow01/12.png)
...
![](/images/vulnhub-jangow01/13.png)
...
![](/images/vulnhub-jangow01/14.png)
...
![](/images/vulnhub-jangow01/16.png)
...
![](/images/vulnhub-jangow01/17.png)
...
![](/images/vulnhub-jangow01/18.png)
...
![](/images/vulnhub-jangow01/19.png)
...
![](/images/vulnhub-jangow01/21.png)
