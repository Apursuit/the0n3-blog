...
description: >-
  永恒之蓝（MS17-010 / CVE-2017-0143）漏洞复现：利用 Windows SMBv1 的远程代码执行漏洞，先用 nmap 的 smb-vuln-ms17-010 脚本探测，再用 Metasploit 的 ms17_010_eternalblue 模块攻陷 Windows Server 2008 R2，获取 meterpreter 会话与系统最高权限，附 meterpreter 常用命令及修复建议。
---

经典漏洞复现：MS17-010 / CVE-2017-0143，永恒之蓝
