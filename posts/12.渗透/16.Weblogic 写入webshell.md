...
description: >-
  WebLogic 写入 WebShell 实战：通过 CVE-2016-0638 反序列化漏洞拿到命令执行后，利用 autodeploy 目录的自动部署机制落地 JSP 马——创建子目录写 jsp、上传 war 包，或用 certutil 远程下载 war 到 autodeploy，再用蚁剑连接，并对比各方式的解析成败。
---
...
![](/images/weblogic-shell/3.png)

成功解析jsp

![](/images/weblogic-shell/4.png)
...
![](/images/weblogic-shell/5.png)

蚁剑连接

![](/images/weblogic-shell/6.png)

![](/images/weblogic-shell/7.png)

直接在`autodeploy`目录下创建jsp webshell不会解析，需要有一层文件夹

![](/images/weblogic-shell/8.png)
...
![](/images/weblogic-shell/9.png)

测试war格式1/1.jsp

![](/images/weblogic-shell/10.png)

![](/images/weblogic-shell/11.png)

![](/images/weblogic-shell/12.png)


测试rar格式2/2.jsp，解析失败404

![](/images/weblogic-shell/13.png)

拷打哈基米，weblogic允许的rar格式并不是常用的压缩rar格式，所以失败了

![](/images/weblogic-shell/14.png)
