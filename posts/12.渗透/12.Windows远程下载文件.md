...
permalink: /pages/windows-remote-download/
categories:
  - 总结
tags: []
author: 
...
description: >-
  Windows 远程下载文件与无文件落地笔记：汇总 certutil -urlcache、PowerShell 的 WebClient.DownloadFile、IEX DownloadString 内存无文件执行、-EncodedCommand Base64 编码命令、bitsadmin、curl 等常用方式，用于载荷投递与 C2 上线。
---
