...
permalink: /posts/windows-admin-to-system/
tags: 
- SeDebugPrivilege
...
sidebar: true
description: >-
  Windows 提权实战：从 Administrator 提升到 SYSTEM 的几种方法。一是借管理员权限创建服务（PsExec、schtasks）；二是利用特权窃取令牌——用 SeDebugPrivilege 复制 winlogon 等 SYSTEM 进程令牌，或用 SeImpersonatePrivilege 配合 Potato 家族（Hot/Rotten/Juicy/Rogue）、PrintSpoofer、GodPotato 诱骗 SYSTEM 认证并模拟其令牌。含完整 C 代码实现。
---
...
![psexec获取system权限](/images/Admin2System/1.png)
...
![创建服务获取system权限](/images/Admin2System/2.png)
...
![SeDebugPrivilege窃取令牌获取system权限](/images/Admin2System/3.png)
...
![PrintSpoofer获取system权限](/images/Admin2System/4.png)
