...
sidebar: true
description: >-
  LNK 文件钓鱼实验（Windows）：拆解快捷方式钓鱼的完整攻击链——修改 LNK 的目标、起始位置、运行方式与图标，把恶意程序伪装成 PDF / 文本等常见文档，配合隐藏目录与迷惑文件诱导点击；并进阶演示 PowerShell 远程加载的无文件落地，以及 mshta.exe 加载 HTA、rundll32.exe 加载远程 SCT 等隐蔽跳板，最后给出防御建议。
---
...
通过[https://www.revshells.com/](https://www.revshells.com/)生成powershell反弹shell脚本可以做简单的远程控制测试
