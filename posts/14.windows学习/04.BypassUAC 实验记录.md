...
![ICMLuaUtil COM类 提升](/images/comBypassuac/3.png)

运行时火绒未拦截，成功获得具有高完整性令牌的 cmd 进程，实验取得初步成功。

![ICMLuaUtil 接口BypassUAC实验成功](/images/comBypassuac/2.png)
...
![载荷形态与远程通信效果](/images/comBypassuac/4.png)
