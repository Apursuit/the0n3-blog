...
description: >-
  CTF Web 靶场搭建：基于 Debian 12 + Docker 部署 GZCTF 平台并集成 DVWA、sqli-labs、pikachu、rce-labs 等靶场，含 apt 换源、Docker 安装与镜像加速、开机自动替换入口 IP（systemd 服务）、开机横幅，以及用浏览器控制台脚本批量导入/启用 sqli-labs、upload-labs 题目的完整流程，最终导出虚拟机供新人使用。
---
