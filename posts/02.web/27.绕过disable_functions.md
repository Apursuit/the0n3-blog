...
description: >-
  WebShell 绕过 disable_functions 姿势合集：系统整理 LD_PRELOAD、ShellShock（CVE-2014-6271）、Apache Mod CGI、PHP-FPM（LD_PRELOAD 与 FastCGI 伪造）、Json Serializer UAF、PHP7 GC UAF、FFI 扩展、ICONV GCONV_PATH 等九种绕过方式，基于 AntSword-Labs 环境复现并附蚁剑插件用法。
---
...
![1](/images/disable_func/1.png)

burp

![2](/images/disable_func/2.png)


抓包

![3](/images/disable_func/3.png)
...
![5](/images/disable_func/5.png)

在webshell管理界面，加载插件

![6](/images/disable_func/6.png)

在插件界面，可以看到，插件有多种方式绕过disable_functions

![7](/images/disable_func/7.png)
...
![25](/images/disable_func/25.png)

开日

![26](/images/disable_func/26.png)

![27](/images/disable_func/27.png)
...
![22](/images/disable_func/22.png)

![23](/images/disable_func/23.png)
...
![30](/images/disable_func/30.png)

蚁剑插件直接开日

使用前，蚁剑为什么没有检测到ffi开启呢？

![31](/images/disable_func/31.png)
