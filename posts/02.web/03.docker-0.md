...
description: >-
  Docker 搭建 upload-labs 文件上传靶场环境：记录 docker search / pull / images / run 拉取并运行 upload-labs 镜像、处理 80 端口占用（ps / stop / rm -f）、exec 进入容器、给 upload 目录授权 www-data 的完整流程，顺带练习常用 Docker 命令。
---
