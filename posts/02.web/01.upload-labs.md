...
description: >-
  upload-labs 文件上传靶场 pass1-10 通关 Writeup：覆盖前端 JS 校验、后端 MIME 校验、历史扩展名（php2/php3/phtml）、.htaccess 解析、Windows 文件名特性（大小写不敏感、首尾空格、末尾点、::$data）、组合绕过与双写绕过等经典文件上传绕过技巧。
---
...
![源码](/images/upload01-10/1-01.jpg)


可以使用禁用javascript脚本的插件或者浏览器开发者工具里自带功能，我使用扩展插件禁用js

![禁用js](/images/upload01-10/1-02.jpg)

![复制图片路径](/images/upload01-10/1-04.jpg)
禁用js，成功上传文件，右键复制图片上传路径，访问文件，php语句成功解析(后续得到的此php语句解析成功的图片省略)

![成功解析](/images/upload01-10/1-03.jpg)
...
![php3](/images/upload01-10/3-01.jpg)
...
![5-01](/images/upload01-10/5-01.png)
...
![06](/images/upload01-10/6-01.png)
...
![07](/images/upload01-10/7-01.png)
...
![08](/images/upload01-10/8-01.png)
...
![9-01](/images/upload01-10/9-01.png)
...
![10-01](/images/upload01-10/10-01.png)
