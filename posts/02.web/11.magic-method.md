...
description: >-
  PHP 反序列化魔术方法速查：整理 __construct、__destruct、__toString、__invoke、__call、__sleep、__wakeup、__get、__set、__isset、__unset、__callStatic 的触发时机与作用，附示例代码，并记录 O:数字 正则绕过与 CVE-2016-7124 的 wakeup 绕过技巧。
---

> PHP是世界上最好的语言

入门反序列化，记录魔术方法的触发时机和作用，附带示例
...
参考：
- [php反序列化\pop](https://baozongwi.xyz/2024/09/07/php%E5%8F%8D%E5%BA%8F%E5%88%97%E5%8C%96-pop/#0x02-question)  

- [橙子科技 陈腾老师](https://www.bilibili.com/video/BV1R24y1r71C)  
