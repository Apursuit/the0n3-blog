...
description: >-
  常见 WebShell 客户端流量特征分析（上）：以蚁剑（AntSword）和中国菜刀为例，结合 Burp / Wireshark 抓包，分析其 POST 请求、老古董 UA 头、base64 编码 payload、随机参数名、伪装百度爬虫 UA、随机 XFF 头等流量特征，并解读蚁剑的信息探针与 open_basedir 绕过代码。
---
...
![1](/images/webshell/1.png)


burp开启拦截

![2](/images/webshell/2.png)

配置蚁剑代理，使流量走8080端口，点击测试，可以看到burp抓包。保存配置，重启生效。

![3](/images/webshell/3.png)

使用蚁剑连接准备好的服务器webshell，拦截到了webshell连接时的请求

![4](/images/webshell/4.png)
...
![7](/images/webshell/7.png)

![8](/images/webshell/8.png)
...
![9](/images/webshell/9.png)

![10](/images/webshell/10.png)
...
![11](/images/webshell/11.png)

wireshark抓包，筛选http请求，找webshell的POST请求，追踪http流

![12](/images/webshell/12.png)
