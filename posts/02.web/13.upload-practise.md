...
description: >-
  BUUCTF 文件上传题解记录：涵盖 [极客大挑战 2019]Upload、[ACTF2020 新生赛]Upload、[MRCTF2020]你传你🐎呢、[GXYCTF2019]BabyUpload 四道题，涉及 MIME 绕过、.phtml 扩展名、GIF89a 图片文件头、<script language='php'> 写法、禁用 JS 与 .htaccess 解析等技巧。
---
...
![1](/images/upload-practise/1.png)
...
![2](/images/upload-practise/2.png)
...
![3](/images/upload-practise/3.png)
...
![5](/images/upload-practise/5.png)
