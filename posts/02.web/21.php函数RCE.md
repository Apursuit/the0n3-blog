...
description: >-
  PHP 代码执行 / 命令执行 / 后门函数速查：系统整理 eval、assert、system、passthru、exec、shell_exec、popen、include、preg_replace(/e)、create_function、call_user_func(_array)、array_map / filter / walk / reduce、usort、动态函数调用与反引号等函数的执行方式与利用点，并附一套 PHP 5.5 的 RCE 练习源码。
---

记录一些php常用rce/后门/代码命令执行函数

## eval语言构造器

官方定义

![1](/images/phpfunc/1.png)
...
![3](/images/phpfunc/3.png)

![4](/images/phpfunc/4.png)
...
![10](/images/phpfunc/10.png)

`preg_replace($pattern,$replacement,$subject);`

在官方文档里找不到恶意利用的模式了

![11](/images/phpfunc/11.png)
...
![12](/images/phpfunc/12.png)

![14](/images/phpfunc/14.png)
...
![18](/images/phpfunc/18.png)

使用`is_callable()`函数判断一个函数是否可调


![19](/images/phpfunc/19.png)

注意`eval`是语言构造器，不算是函数

![20](/images/phpfunc/20.png)
...
![22](/images/phpfunc/22.png)

![23](/images/phpfunc/23.png)
...
![29](/images/phpfunc/29.png)

试图找出一些问题，好像找不到

![30](/images/phpfunc/30.png)
