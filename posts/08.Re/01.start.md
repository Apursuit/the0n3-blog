...
![题目](/images/re01/0.png)

扔进PEID

![题目1](/images/re01/1.png)

看出是vc++6.0写的，无壳,直接扔OD，进行中文引擎搜索

![od](/images/re01/2.png)

双击看汇编，定位到了字符串位置，往上可以看到最近的一条**je指令**

![je](/images/re01/3.png)

双击这条指令即可修改，修改为空指令nop

![nop](/images/re01/5.png)

点击左上方的调试按钮，或者右键 copy to executable，选择生成一个新的exe文件，保存即可

![调试](/images/re01/4.png)

点击运行，随意用户密码，成功进入程序

![成功](/images/re01/6.png)

### 尝试

怎么不填账号密码直接登录成功？找到不填账号密码的提示定位

![提示](/images/re01/7.png)

把这里je指令也改nop试试

改完没有直接弹登录成功。预期的弹出了账号密码不能为空

![弹窗](/images/re01/8.png)

具体看看这里的汇编代码

![汇编](/images/re01/9.png)
...
![jmp](/images/re01/10.png)

![success](/images/re01/11.png)
...
![DIE](/images/re01/13.png)

加了壳，先运行这个exe，然后打开OD，attach到这个exe上

![attach](/images/re01/14.png)

ctrl+G，输入入口点地址00401000，然后就可以按照第一题来做

> [!TIP]
> 疑问：为什么在OD中输入入口点地址00401000  
> 系统默认通常程序领空的起始地址，跳过壳，进入程序入口

![断点](/images/re01/15.png)

![display](/images/re01/16.png)

找到位置

![postion](/images/re01/17.png)

同样可以直接改成nop指令

调试

![debug](/images/re01/18.png)
...
![jnz](/images/re01/19.png)

![eax](/images/re01/20.png)

![debug](/images/re01/21.png)
...
![update](/images/re01/22.png)

再调试就可以了

![debug](/images/re01/23.png)
