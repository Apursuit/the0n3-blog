...
![5](/images/gayfork/5.png)

找到左侧上游同步，找到`enable workflow`，启用

![6](/images/gayfork/6.png)

手动运行一次workflow，看看是否成功

![7](/images/gayfork/7.png)

![8](/images/gayfork/8.png)

查看运行细节，成功同步。因为我已经网页手动同步了，这里就没有新的更新需要同步了，所以没有更新。

![9](/images/gayfork/9.png)
