...
description: >-
  Flask 无法访问 console 的解决（2024）：Werkzeug 3.0.3 起默认禁止非 localhost 访问 debug console，其他主机访问 /console 会返回 400。本文给出两种方案——用 HackBar 等工具伪造 Host: 127.0.0.1 绕过，或在 venv 中降级安装 Werkzeug==3.0.2 恢复访问，并附复现用 app.py
---
...
可以使用hackerbar，添加`Host`字段伪造ip`127.0.0.1`，推荐使用 chrome、edge、firefox 浏览器使用插件修改 http头

![4](/images/flask-console/4.png)
...
![3](/images/flask-console/3.png)

![2](/images/flask-console/2.png)
