...
![1](/images/docker_0/1.png)

选择一个没有其他组件的镜像

![2](/images/docker_0/2.png)
...
![5](/images/docker_0/5.png)

配置文件中**修改需要的相关参数**(选做)

![6](/images/docker_0/6.png)
...
再访问网页看看效果，PHP文件正确解析
![12](/images/docker_0/12.png)

传参查看**phpinfo()**,发现allow_url_include没有被修改~(慌)~
![13](/images/docker_0/13.png)
...
![15](/images/docker_0/15.png)

现在再次访问测试可以发现参数已经完成修改！
![14](/images/docker_0/14.png)
