---
title: GZCTF Docker Compose 部署教程（Ubuntu 22.04）
...
description: >-
  GZCTF CTF 平台 Docker Compose 部署教程（Ubuntu 22.04）：涵盖系统换源、安装 Docker 与 Compose、配置镜像加速、用脚本一键生成 .env 与 appsettings.json（管理员密码、数据库密码、XOR_KEY、PublicEntry），编写 compose.yml 启动服务，并演示创建比赛与发布 sqli-labs 题目。
---
...
建议阅读官方文档：[【快速上手】](https://gzctf.gzti.me/zh/guide/start/quick-start.html)
...
![验证docker状态](/images/GZCTF/15.png)
...
![docker镜像加速](/images/GZCTF/16.png)
...
![docker加速镜像脚本](/images/GZCTF/17.png)
...
![创建配置文件](/images/GZCTF/19.png)

检查 appsettings.json 文件内容是否正确，尤其是PublicEntry 参数

![配置平台信息](/images/GZCTF/20.png)
...
![验证GZCTF平台启动](/images/GZCTF/21.png)
...
![GZCTF平台资源占用](/images/GZCTF/24.png)
...
![GZCTF管理](/images/GZCTF/25.png)

新建比赛

![GZCTF新建比赛](/images/GZCTF/26.png)

![GZCTF比赛信息](/images/GZCTF/27.png)

可以对比赛信息进行修改

![GZCTF比赛信息修改](/images/GZCTF/28.png)

点击题目管理，新建题目

![GZCTF题目管理](/images/GZCTF/29.png)

以 sqli-labs 靶场为例

![GZCTF拉取sqli-labs](/images/GZCTF/30.png)

在 docker labs找到热门的sqli-labs镜像，填到题目的容器镜像地址

![GZCTF填入sqli-labs镜像](/images/GZCTF/31.png)

https://hub.docker.com/r/acgpiano/sqli-labs

镜像地址 `acgpiano/sqli-labs:latest`

![GZCTF题目镜像地址](/images/GZCTF/32.png)

保存题目，也可以直接先测试题目

![GZCTF测试题目](/images/GZCTF/33.png)

访问测试题目地址

![访问测试题目](/images/GZCTF/34.png)

发布题目

![GZCTF发布题目](/images/GZCTF/35.png)
