...
![ubuntu](/images/ubuntu-install/00.png)

于是给老爷机安装了ubuntu，记录一下安装过程

![ubuntu](/images/ubuntu-install/0.png)
...
![ali](/images/ubuntu-install/1.png)
...
![easyBCD](/images/ubuntu-install/3.png)

下载这里的免费版本

![下载安装](/images/ubuntu-install/4.png)

点击左侧添加新条目--》添加引导项--》下方“便携式/外接存储” 名称是开机选择时的引导项名称，路径选择镜像位置，模式从磁盘运行，最后点击加号

![添加](/images/ubuntu-install/5.png)

点击左侧”编辑引导菜单“

可以暂时把安装镜像引导作为默认，下方勾选use Metro...，最后保存配置

![配置](/images/ubuntu-install/6.png)

## 准备空闲扇区

本就不富裕的c盘..再砍15g来测试安装ubuntu

![空闲扇区](/images/ubuntu-install/7.png)
...
![引导](/images/ubuntu-install/8.png)
...
![chose](/images/ubuntu-install/9.png)
 ### 语言

语言继续使用eng或者换为Chinese

![语言](/images/ubuntu-install/10.png)
...
![display](/images/ubuntu-install/11.png)

选择这个15g的空闲区，点击左下的-减号格式化一下，现在名称变为空闲
![free](/images/ubuntu-install/12.png)
再次选中，点击左下角的+加号，给ubuntu具体目录分配容量
挂载点选择
boot  1024m    逻辑分区，空间起始位置
swap  4096m    交换分区  (建议物理内存的2倍)
/     剩余容量  主分区 ，空间起始位置
![boot](/images/ubuntu-install/boot.png)
![swap](/images/ubuntu-install/swap.png)
![root](/images/ubuntu-install/root.png)

注意:请检查启动引导设备是否正确！即boot分区对应你的引导盘位置

![important](/images/ubuntu-install/important.png)

现在一切无误，开始安装！
报错，提示找不到efi启动系统，**无视风险，继续安装**

![efi](/images/ubuntu-install/efi.png)

### 时区

上海
![time](/images/ubuntu-install/13.png)
### 注册

注册一个ubuntu系统的使用者(user)
演示
![time](/images/ubuntu-install/14.png)
### 漫长等待

安装成功后，重启

![reboot](/images/ubuntu-install/15.png)
...
![create](/images/ubuntu-install/16.png)

设为默认项
![default](/images/ubuntu-install/17.png)

开机选ubuntu
![ubuntu](/images/ubuntu-install/18.png)
