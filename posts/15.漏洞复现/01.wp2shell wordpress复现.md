---
title: 【vulhub】Wordpres wp2shell未授权RCE复现
...
![](/images/wp-wp2shell/3.png)

使用该账号可以成功登录，并且是管理员权限

![](/images/wp-wp2shell/4.png)

可以修改wordpress自带的`hello dolly`插件，执行任意命令

![](/images/wp-wp2shell/5.png)

在插件源码中添加php代码后， 启用该插件，访问插件页面即可执行php代码

![](/images/wp-wp2shell/6.png)

![](/images/wp-wp2shell/7.png)